...
class Project(Base):
    ...
    genre = Column(String, default="")  # 甜宠/悬疑/古风/都市
    style = Column(String, default="anime")  # anime/chinese/chibi/realistic
    status = Column(String, default="draft")  # draft/generating/completed/error
    input_text = Column(Text, default="")
    input_type = Column(String, default="text")  # text/file/ip
